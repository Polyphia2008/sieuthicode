<?php
// statically decompiled from promotions.php  [structured; all 1 record(s) structured]
...
if (isset($_POST['AddPromotion']) && is_admin_account($data_user)) {
    ...
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h4 class="page-title mb-0">Khuyến mãi nạp tiền</h4>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="#">Nạp tiền</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Khuyến mãi nạp tiền</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    foreach ($promotions as $row) {
        echo '                                <tr>
                                    <td class="text-center">
                                        <div class="form-check form-check-md d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input checkbox" data-id="';
        echo $row['id'];
        ...
        echo 'đ</b></td>
                                    <td class="text-center"><span style="font-size: 15px;" class="badge bg-primary">';
        echo $row['discount'];
        echo '%</span></td>
                                    <td class="text-center">';
