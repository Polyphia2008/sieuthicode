...
if (isset($_POST['AddCategory']) && is_admin_account($data_user)) {
    ...
    $listDatatable = $db->get_list(' SELECT * FROM `categories` WHERE ' . $where . ' ORDER BY `stt` ASC LIMIT ' . $from . ',' . $limit . ' ');
    $totalDatatable = $db->num_rows(' SELECT * FROM `categories` WHERE ' . $where . ' ORDER BY id DESC ');
    $urlDatatable = pagination('/cpanel/category/view?name=' . $name . '&', $from, $totalDatatable, $limit);
                    ...
                    <table class="table table-borderless table-striped table-vcenter">
                        <thead>
                            <tr>
                                ...
                                <th class="d-sm-table-cell text-center">Icon</th>
    ...
    foreach ($listDatatable as $category) {
        ...
        echo '</a>
                                    ...
                                    <td class="d-sm-table-cell text-center fs-sm"><img src="';
        echo $category['icon'];
        echo '" width="50px" /></td>
        ...
        echo '>
                                    ...
                                    <td class="text-center fs-sm">
                                        <a class="btn btn-sm btn-alt-secondary" href="/cpanel/category/update/';
        echo $category['id'];
        echo '">
                                            <i class="fa fa-fw fa-edit"></i>
                                        </a>
                                        <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)" onclick="confirmAction(';
        echo $category['id'];
        echo ')">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="block-content">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="content" placeholder="Mô tả" required></textarea>
                        </div>
                    </div>
