 ...
 * Copyright (c) 2024
 */
/*! For license information please see dashmix.app.min-5.9.txt */
!function() {
    var e = {
        610: function(e) {
    ...
    function() {
            ...
            fn: function(e) {
                ...
                Object.keys(t.elements).forEach((function(e) {
                    var i = t.styles[e] || {}
                      , s = t.attributes[e] || {}
                      , n = t.elements[e];
                    j(n) && S(n) && (Object.assign(n.style, i),
            ...
            effect: function(e) {
                ...
                function() {
                    Object.keys(t.elements).forEach((function(e) {
                        ...
                        j(s) && S(s) && (Object.assign(s.style, o),
        ...
        function W(e, t, i) {
            ...
            var s = e.getBoundingClientRect()
              , n = 1
              , o = 1;
            t && j(e) && (n = e.offsetWidth > 0 && F(s.width) / e.offsetWidth || 1,
        ...
        function Y(e) {
            ...
            return i && ("html" === S(i) || "body" === S(i) && "static" === z(i).position) ? t : i || function(e) {
                ...
                if (/Trident/i.test(I()) && j(e) && "fixed" === z(e).position)
                    return null;
                var i = Q(e);
        ...
        var G = {
            ...
            phase: "main",
            fn: function(e) {
                var t, i = e.state, a = e.name, c = e.options, d = i.elements.arrow, h = i.modifiersData.popperOffsets, u = P(i.placement), p = X(u), f = [r, o].indexOf(u) >= 0 ? "height" : "width";
                if (d && h) {
                    var m = function(e, t) {
        ...
        function te(e) {
            var t, i = e.popper, a = e.popperRect, l = e.placement, c = e.variation, h = e.offsets, u = e.position, p = e.gpuAcceleration, f = e.adaptive, m = e.roundOffsets, g = e.isFixed, _ = h.x, b = void 0 === _ ? 0 : _, v = h.y, y = void 0 === v ? 0 : v, w = "function" == typeof m ? m({
                x: b,
                y: y
            }) : {
                x: b,
            ...
            if (f) {
                var S = Y(i)
                  , O = "clientHeight"
                  , j = "clientWidth";
                S === C(i) && "static" !== z(S = R(i)).position && "absolute" === u && (O = "scrollHeight",
                j = "scrollWidth"),
                (l === s || (l === r || l === o) && c === d) && (A = n,
                y -= (g && S === L && L.visualViewport ? L.visualViewport.height : S[O]) - a.height,
                y *= p ? 1 : -1),
                l !== r && (l !== s && l !== n || c !== d) || (k = o,
                b -= (g && S === L && L.visualViewport ? L.visualViewport.width : S[j]) - a.width,
                b *= p ? 1 : -1)
            }
            var T, D = Object.assign({
                position: u
            }, f && ee), P = !0 === m ? function(e, t) {
                var i = e.x
                  , s = e.y
            ...
            return b = P.x,
            y = P.y,
            p ? Object.assign({}, D, ((T = {})[A] = x ? "0" : "",
            T[k] = E ? "0" : "",
            T.transform = (L.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + y + "px)" : "translate3d(" + b + "px, " + y + "px, 0)",
            T)) : Object.assign({}, D, ((t = {})[A] = x ? y + "px" : "",
            t[k] = E ? b + "px" : "",
            t.transform = "",
            t))
        }
        ...
        function me(e, t, i) {
            return t === u ? fe(function(e, t) {
                ...
                var t, i = R(e), s = ce(e), n = null == (t = e.ownerDocument) ? void 0 : t.body, o = N(i.scrollWidth, i.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0), r = N(i.scrollHeight, i.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0), a = -s.scrollLeft + de(e), l = -s.scrollTop;
        ...
        function ge(e) {
            var t, i = e.reference, a = e.element, l = e.placement, h = l ? P(l) : null, u = l ? J(l) : null, p = i.x + i.width / 2 - a.width / 2, f = i.y + i.height / 2 - a.height / 2;
            switch (h) {
            case s:
                t = {
                    x: p,
                ...
                if (!t.modifiersData[d]._skip) {
                    ...
                    if (D)
                        for (var Q = function(e) {
                            ...
                            ;
                    t.placement !== N && (t.modifiersData[d]._skip = !0,
                    t.placement = N,
                    t.reset = !0)
                }
            },
        ...
        var we = {
          ...
          , ke = {
            ...
            fn: function(e) {
                ...
                if (S) {
                    if (d) {
                        var I, q = "y" === A ? s : r, W = "y" === A ? n : o, H = "y" === A ? "height" : "width", z = S[A], B = z + w[q], R = z - w[W], Q = b ? -O[H] / 2 : 0, V = x === c ? C[H] : O[H], K = x === c ? -O[H] : -C[H], Z = t.elements.arrow, G = b && Z ? $(Z) : {
                            width: 0,
                            height: 0
                            ...
                            bottom: 0,
                            left: 0
                        }, te = ee[q], ie = ee[W], se = U(0, C[H], G[H]), ne = k ? C[H] / 2 - Q - se - te - T.mainAxis : V - se - te - T.mainAxis, oe = k ? -C[H] / 2 + Q + se + ie + T.mainAxis : K + se + ie + T.mainAxis, re = t.elements.arrow && Y(t.elements.arrow), ae = re ? "y" === A ? re.clientTop || 0 : re.clientLeft || 0 : 0, le = null != (I = null == D ? void 0 : D[A]) ? I : 0, ce = z + oe - le, de = U(b ? M(B, z + ne - le - ae) : B, z, b ? N(R, ce) : R);
                        S[A] = de,
                        F[A] = de - z
                    }
                    if (u) {
                        var he, ue = "x" === A ? s : r, pe = "x" === A ? n : o, fe = S[L], me = "y" === L ? "height" : "width", ge = fe + w[ue], be = fe - w[pe], ve = -1 !== [s, r].indexOf(E), ye = null != (he = null == D ? void 0 : D[L]) ? he : 0, we = ve ? ge : fe - C[me] - O[me] - ye + T.altAxis, Ee = ve ? fe + C[me] + O[me] - ye - T.altAxis : be, xe = b && ve ? function(e, t, i) {
                            var s = U(e, t, i);
                            return s > i ? i : s
        ...
        const Pe = new Map
          , Ne = {
            ...
            remove(e, t) {
                ...
                const i = Pe.get(e);
                i.delete(t),
                0 === i.size && Pe.delete(e)
            }
        }
          , Me = "transitionend"
          , Fe = e=>(e && window.CSS && window.CSS.escape && (e = e.replace(/#([^\s"#']+)/g, ((e,t)=>`#${CSS.escape(t)}`))),
        e)
          , Ie = e=>{
            e.dispatchEvent(new Event(Me))
        }
          , qe = e=>!(!e || "object" != typeof e) && (void 0 !== e.jquery && (e = e[0]),
        void 0 !== e.nodeType)
          , We = e=>qe(e) ? e.jquery ? e[0] : e : "string" == typeof e && e.length > 0 ? document.querySelector(Fe(e)) : null
          , $e = e=>{
            if (!qe(e) || 0 === e.getClientRects().length)
                return !1;
          ...
          , Ze = (e,t,i,s)=>{
            const n = e.length;
            let o = e.indexOf(t);
            return -1 === o ? !i && s ? e[n - 1] : e[0] : (o += i ? 1 : -1,
            s && (o = (o + n) % n),
        ...
        function dt(e, t, i, s, n) {
            const o = at(t[i], s, n);
            o && (e.removeEventListener(i, o, Boolean(n)),
        ...
        class It extends bt {
            ...
            _initEvents() {
                this._supportPointerEvents ? (pt.on(this._element, Pt, (e=>this._start(e))),
                pt.on(this._element, Nt, (e=>this._end(e))),
                this._element.classList.add("pointer-event")) : (pt.on(this._element, jt, (e=>this._start(e))),
        ...
        class ri extends vt {
            ...
            _addEventListeners() {
                ...
                "hover" === this._config.pause && (pt.on(this._element, Yt, (()=>this.pause())),
        ...
        class yi extends vt {
            ...
            show() {
                if (this._isTransitioning || this._isShown())
                    return;
                let e = [];
                if (this._config.parent && (e = this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter((e=>e !== this._element)).map((e=>yi.getOrCreateInstance(e, {
                    toggle: !1
                })))),
                e.length && e[0]._isTransitioning)
                    return;
                if (pt.trigger(this._element, li).defaultPrevented)
                    return;
                for (const t of e)
                    t.hide();
            ...
            hide() {
                if (this._isTransitioning || !this._isShown())
                    return;
                if (pt.trigger(this._element, di).defaultPrevented)
                    return;
        ...
        class Qi extends vt {
            ...
            _getPopperConfig() {
                ...
                {
                    ...e,
                    ...Ue(this._config.popperConfig, [e])
                }
            }
        ...
        class Zi extends bt {
            ...
            dispose() {
                this._isAppended && (pt.off(this._element, Xi),
                this._element.remove(),
                this._isAppended = !1)
            }
            _getElement() {
        ...
        class cs {
            ...
            _applyManipulationCallback(e, t) {
                if (qe(e))
                    ...
                    for (const i of wt.find(e, this._element))
                        t(i)
            }
        }
        const ds = ".bs.modal"
        ...
        class Ls extends vt {
            ...
            show(e) {
                this._isShown || this._isTransitioning || pt.trigger(this._element, fs, {
                    relatedTarget: e
            ...
            hide() {
                this._isShown && !this._isTransitioning && (pt.trigger(this._element, hs).defaultPrevented || (this._isShown = !1,
                this._isTransitioning = !0,
            ...
            _triggerBackdropTransition() {
                if (pt.trigger(this._element, us).defaultPrevented)
                    return;
                const e = this._element.scrollHeight > document.documentElement.clientHeight
                  , t = this._element.style.overflowY;
                "hidden" === t || this._element.classList.contains(xs) || (e || (this._element.style.overflowY = "hidden"),
        ...
        class Rs extends vt {
            ...
            show(e) {
                this._isShown || pt.trigger(this._element, Ns, {
                    relatedTarget: e
                }).defaultPrevented || (this._isShown = !0,
                this._backdrop.show(),
            ...
            hide() {
                this._isShown && (pt.trigger(this._element, Fs).defaultPrevented || (this._focustrap.deactivate(),
                this._element.blur(),
                this._isShown = !1,
        ...
        pt.on(window, Ws, (()=>{
            for (const e of wt.find("[aria-modal][class*=show][class*=offcanvas-]"))
                "fixed" !== getComputedStyle(e).position && Rs.getOrCreateInstance(e).hide()
        }
        )),
        Et(Rs),
        Xe(Rs);
        ...
        class dn extends vt {
            ...
            _getPopperConfig(e) {
                ...
                return {
                    ...t,
                    ...Ue(this._config.popperConfig, [t])
                }
            }
            _setListeners() {
                ...
                for (const t of e)
                    if ("click" === t)
                        ...
                        pt.on(this._element, i, this._config.selector, (e=>{
                            const t = this._initializeOnDelegatedTarget(e);
                            t._activeTrigger["focusout" === e.type ? rn : on] = t._element.contains(e.relatedTarget),
                            t._leave()
                        }
                        ))
                    }
            ...
            _configAfterMerge(e) {
                return e.container = !1 === e.container ? document.body : We(e.container),
        ...
        class kn extends vt {
            ...
            _maybeEnableSmoothScroll() {
                this._config.smoothScroll && (pt.off(this._config.target, gn),
            ...
            _initializeTargetsAndObservables() {
                ...
                for (const t of e) {
                    ...
                    $e(e) && (this._targetLinks.set(decodeURI(t.hash), t),
            ...
            _activateParents(e) {
                if (e.classList.contains("dropdown-item"))
                    wt.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(bn);
                else
                    for (const t of wt.parents(e, ".nav, .list-group"))
                        for (const e of wt.prev(t, wn))
                            e.classList.add(bn)
            }
            _clearActiveClass(e) {
        ...
        class Yn extends vt {
            ...
            _keydown(e) {
                if (![Pn, Nn, Mn, Fn, In, qn].includes(e.key))
                    return;
                e.stopPropagation(),
                e.preventDefault();
        ...
        pt.on(window, Dn, (()=>{
            for (const e of wt.find(Vn))
                Yn.getOrCreateInstance(e)
        }
        )),
        Xe(Yn);
        const Xn = ".bs.toast"
        ...
        class lo extends vt {
            ...
            show() {
                pt.trigger(this._element, to).defaultPrevented || (this._clearTimeout(),
            ...
            hide() {
                this.isShown() && (pt.trigger(this._element, Jn).defaultPrevented || (this._element.classList.add(oo),
                this._queueCallback((()=>{
        ...
        co && window.addEventListener("resize", (function() {
            Io !== window.devicePixelRatio && (Io = window.devicePixelRatio,
            Fo = null)
        }
        ));
        var Ho = function(e) {
          ...
          , Go = function() {
            function e(t, i) {
                ...
                this.onMouseEnter = function() {
                    s.isMouseEntering || (Uo(s.el, s.classNames.mouseEntered),
                    s.showScrollbar("x"),
                    s.showScrollbar("y"),
                    s.isMouseEntering = !0),
                    s.onMouseEntered()
                ...
                this.onMouseMove = function(e, t, i) {
                    ...
                    if ("function" != typeof e)
                        throw new TypeError("Expected a function");
                    return ho(i) && (s = "leading"in i ? !!i.leading : s,
                ...
                this.onStopScrolling = No(this._onStopScrolling, this.stopScrollDelay),
                this.onMouseEntered = No(this._onMouseEntered, this.stopScrollDelay),
                this.init()
            }
            ...
            e.prototype.initDOM = function() {
                ...
                this.options.autoHide || (Uo(this.axis.x.scrollbar.el, this.classNames.visible),
                Uo(this.axis.y.scrollbar.el, this.classNames.visible))
            }
            ,
            ...
            e.prototype.recalculate = function() {
                if (this.heightAutoObserverEl && this.contentEl && this.contentWrapperEl && this.wrapperEl && this.placeholderEl) {
                    ...
                    this.placeholderEl.style.width = s ? "".concat(t || l, "px") : "auto",
            ...
            e.prototype.getScrollbarSize = function(e) {
                ...
                !this.axis[e].isOverflowing || !this.contentEl)
                    return 0;
                var s, n = this.contentEl[this.axis[e].scrollSizeAttr], o = null !== (i = null === (t = this.axis[e].track.el) || void 0 === t ? void 0 : t[this.axis[e].offsetSizeAttr]) && void 0 !== i ? i : 0, r = o / n;
                return s = Math.max(~~(r * o), this.options.scrollbarMinSize),
            ...
            e.prototype.positionScrollbar = function(t) {
                ...
                if (this.axis[t].isOverflowing && this.contentWrapperEl && o.el && this.elStyles) {
                    ...
                    o.el.style.transform = "x" === t ? "translate3d(".concat(h, "px, 0, 0)") : "translate3d(0, ".concat(h, "px, 0)")
                }
            }
            ,
            ...
            e.prototype.showScrollbar = function(e) {
                void 0 === e && (e = "y"),
                this.axis[e].isOverflowing && !this.axis[e].scrollbar.isVisible && (Uo(this.axis[e].scrollbar.el, this.classNames.visible),
                this.axis[e].scrollbar.isVisible = !0)
            }
            ,
            e.prototype.hideScrollbar = function(e) {
                void 0 === e && (e = "y"),
                this.axis[e].isOverflowing && this.axis[e].scrollbar.isVisible && (Ko(this.axis[e].scrollbar.el, this.classNames.visible),
            ...
            e.prototype.onMouseMoveForAxis = function(e) {
                ...
                this.isWithinBounds(t.scrollbar.rect) ? Uo(t.scrollbar.el, this.classNames.hover) : Ko(t.scrollbar.el, this.classNames.hover)) : (Ko(t.track.el, this.classNames.hover),
                this.options.autoHide && this.hideScrollbar(e)))
            }
            ,
            e.prototype.onMouseLeaveForAxis = function(e) {
                void 0 === e && (e = "y"),
                Ko(this.axis[e].track.el, this.classNames.hover),
                Ko(this.axis[e].scrollbar.el, this.classNames.hover),
                this.options.autoHide && this.hideScrollbar(e)
            }
            ,
            e.prototype.onDragStart = function(e, t) {
                ...
                s.addEventListener("dblclick", this.preventClick, !0)) : (n.clearTimeout(this.removePreventClickId),
            ...
            e.prototype.onTrackClick = function(e, t) {
                ...
                if (this.options.clickOnTrack && a.scrollbar.el && this.contentWrapperEl) {
                    ...
                    var c = null !== (s = null === (i = this.axis[t].scrollbar.rect) || void 0 === i ? void 0 : i[this.axis[t].offsetAttr]) && void 0 !== s ? s : 0
                      ...
                      , p = -1 === u ? h - d : h + d
                      , f = function() {
                        r.contentWrapperEl && (-1 === u ? h > p && (h -= 40,
                        r.contentWrapperEl[r.axis[t].scrollOffsetAttr] = h,
                        l.requestAnimationFrame(f)) : h < p && (h += 40,
                        r.contentWrapperEl[r.axis[t].scrollOffsetAttr] = h,
          ...
          , sr = function(e) {
            ...
            t.prototype.initDOM = function() {
                ...
                if (!Array.prototype.filter.call(this.el.children, (function(e) {
                    ...
                    ir(this.heightAutoObserverEl, this.classNames.heightAutoObserverEl); this.el.firstChild; )
        ...
        class rr {
            ...
            static bsTooltip() {
                ...
                window.helperBsTooltips = e.map((e=>(e.classList.add("js-bs-tooltip-enabled"),
            ...
            static bsPopover() {
                ...
                window.helperBsPopovers = e.map((e=>(e.classList.add("js-bs-popover-enabled"),
            ...
            static dmYearCopy() {
                document.querySelectorAll('[data-toggle="year-copy"]:not(.js-year-copy-enabled)').forEach((e=>{
                    ...
                    e.textContent = parseInt(i) >= t ? t : i + "-" + t.toString().substr(2, 2)
                }
                ))
            }
            static dmRipple() {
                document.querySelectorAll('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').forEach((e=>{
                    ...
                    e.addEventListener("click", (t=>{
                        ...
                        r = e.querySelector("." + o),
                        "0px" !== getComputedStyle(r).height && "0px" !== getComputedStyle(r).width || (i = Math.max(e.offsetWidth, e.offsetHeight),
                        r.style.height = i + "px",
                        r.style.width = i + "px"),
            ...
            static jsSimpleMDE() {
                ...
                e && (document.querySelector(".editor-toolbar > a.fa-header").classList.replace("fa-header", "fa-heading"),
                ...
                jQuery(".js-sparkline:not(.js-sparkline-enabled)").each(((t,i)=>{
                    let s = jQuery(i)
                      ...
                      , r = {
                        ...
                        pie: ()=>{
                            o.type = n,
                            o.sliceColors = ["#fadb7d", "#faad7d", "#75b0eb", "#abe37d"],
                    ...
                    r[n] ? (r[n](),
                    "line" === n && ((s.data("chart-range-min") >= 0 || s.data("chart-range-min")) && (o.chartRangeMin = s.data("chart-range-min")),
                    ...
                    jQuery(i).sparkline(s.data("points") || [0], o)) : console.log("[jQuery Sparkline JS Helper] Please add a correct type (line, bar, pie or tristate) in all your elements with 'js-sparkline' class.")
                }
                ))
            }
            static jqValidation() {
                jQuery.validator.setDefaults({
                    ...
                    ,
                    success: e=>{
                        jQuery(e).parents("div:not(.input-group)").first().find(".is-invalid").removeClass("is-invalid"),
                        jQuery(e).remove()
                    }
                }),
        ...
        class ar {
            ...
            _uiHandleSidebars() {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init"
                  , t = this;
                (t._lSidebar || t._lSideOverlay) && ("init" === e ? (t._lPage.classList.add("side-trans-enabled"),
                ...
                this._uiHandleSidebars("custom-scroll")) : (e = "custom-scroll") && t._lPage.classList.contains("side-scroll") && (t._lSidebar && !t._lSidebarScroll && (t._lSidebarScroll = new sr(t._lSidebarScrollCon)),
                t._lSideOverlay && !t._lSideOverlayScroll && (t._lSideOverlayScroll = new sr(t._lSideOverlay))))
            }
            _uiHandleHeader() {
                let e = this;
                ...
                e && e.forEach((e=>{
                    e.addEventListener("click", (t=>{
                        ...
                        if (!((window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) > 991 && i.classList.contains("nav-main-horizontal") && i.classList.contains("nav-main-hover"))) {
                            ...
                            e.setAttribute("aria-expanded", "false")) : (Array.from(e.closest("ul").children).forEach((e=>{
            ...
            _uiHandlePageLoader() {
                ...
                if ("show" === e)
                    ...
                    "hide" === e && this._lpageLoader && this._lpageLoader.classList.remove("show")
            }
            _uiHandleDarkMode() {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init"
                  , t = this;
                if ("init" !== e || t._lPage.classList.contains("dark-mode") || (t._lPage.classList.contains("sidebar-dark") ? localStorage.setItem("dashmixDefaultsSidebarDark", !0) : localStorage.removeItem("dashmixDefaultsSidebarDark"),
                ...
                t._lPage.classList.contains("remember-theme")) {
                    ...
                    "init" === e ? i ? (t._lPage.classList.add("sidebar-dark"),
                    t._lPage.classList.add("page-header-dark"),
                    t._lPage.classList.add("dark-mode")) : "init" === e && t._lPage.classList.remove("dark-mode") : "on" === e ? localStorage.setItem("dashmixDarkMode", !0) : "off" === e && localStorage.removeItem("dashmixDarkMode")
                } else
                    "init" === e && localStorage.removeItem("dashmixDarkMode")
            }
            _uiHandleTheme() {
                let e = this
            ...
            _uiUpdateTheme(e, t) {
                if ("default" === t)
                    ...
                    e.setAttribute("href", t),
                    document.getElementById("css-main").insertAdjacentElement("afterend", e)
                }
            }
            _uiApiLayout() {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init"
            ...
            _uiApiBlocks() {
                let e, t, i, s = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init", n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], o = "si-size-fullscreen", r = "si-size-actual", a = "si-arrow-up", l = "si-arrow-down", c = {
                    init: ()=>{
                    ...
                    content_toggle: ()=>{
                        ...
                        i && (e.classList.contains("block-mode-hidden") ? i.querySelector("i").classList.replace(a, l) : i.querySelector("i").classList.replace(l, a))
                    }
                    ,
                    content_hide: ()=>{
                    ...
                    state_toggle: ()=>{
                        ...
                        e.querySelector('[data-toggle="block-option"][data-action="state_toggle"][data-action-mode="demo"]') && setTimeout((()=>{
                ...
                "init" === s ? c[s]() : (e = n instanceof Element ? n : document.querySelector("".concat(n)),
                e && (t = e.querySelector('[data-toggle="block-option"][data-action="fullscreen_toggle"]'),
                i = e.querySelector('[data-toggle="block-option"][data-action="content_toggle"]'),
                c[s] && c[s]()))
            }
            onLoad(e) {
