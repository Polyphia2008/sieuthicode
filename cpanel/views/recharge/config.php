...
if (isset($_POST['SaveSettings']) && $data_user['level'] == 'admin') {
    ...
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h4 class="page-title fw-semibold fs-18 mb-0">Cấu hình ngân hàng</h4>
    ...
    <div class="content">
        ...
        foreach ($db->get_list('SELECT * FROM `bank` ORDER BY `id` DESC') as $row) {
            ...
            echo '</td>
                                    <td>';
            echo $row['status'] == 1 ? '<span class="badge bg-success">Hiển thị</span>' : '<span class="badge bg-danger">Ẩn</span>';
            echo '</td>
                                    <td><a aria-label="" href="/cpanel/recharge/bank/edit/';
            echo $row['id'];
            echo '" style="color:white;" class="btn btn-info btn-sm btn-icon-left m-b-10" type="button">
                                            <i class="fas fa-edit mr-1"></i><span class=""> Edit</span>
                                        </a>
                                        <button style="color:white;" onclick="confirmAction(';
            echo $row['id'];
            echo ')" class="btn btn-danger btn-sm btn-icon-left m-b-10" type="button">
    ...
    <div class="content">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control form-control-sm" name="bank_status">
                                        <option ';
        echo $db->site('bank_status') == 0 ? 'selected' : '';
        echo ' value="0">OFF
                                        </option>
                                        <option ';
        echo $db->site('bank_status') == 1 ? 'selected' : '';
        echo ' value="1">ON
                                        </option>
                                    </select>
                                </div>
        ...
        echo $db->site('prefix_autobank');
        echo '" name="prefix_autobank" placeholder="VD: NAPTIEN">
        ...
        echo '" name="bank_max">
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-12">
                                    <textarea id="bank_notice" name="bank_notice">';
        echo $db->site('bank_notice');
        echo '</textarea>
                                </div>
                            </div>
                        </div>
