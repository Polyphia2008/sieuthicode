...
// 54 tables: 46 base + 2 chat + presence + notifications/read receipts + 3 traffic tables.
...
ok(count(installer_planned_tables()) === 54, 'planned_tables parses all 54 real tables');
