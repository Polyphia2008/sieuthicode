...
if (isset($_POST['AddTick']) && is_admin_account($data_user)) {
    if ($db->site('status_demo') != 0) {
        ...
        $isInsert = $db->insert('tick', ['name' => Anti_xss($_POST['name']), 'icon' => $url_icon, 'created_at' => gettime()]);
        if ($isInsert) {
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full overflow-x-auto">
                ...
                <table class="table table-borderless table-striped table-vcenter" id="datatable">
                    ...
                    <tbody>
                        ';
    foreach ($db->get_list(' SELECT * FROM `tick` ORDER BY `id` ASC') as $tag) {
        echo '                            <tr>
        ...
        echo '</td>
                                <td class="text-center fs-sm">
                                    <a class="btn btn-sm btn-primary" href="/cpanel/tick/list/update/';
        echo $tag['id'];
        echo '">
            ...
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="block-content">
                        <div class="mb-4">
                            <label class="form-label" for="example-text-input">Tên</label>
                    ...
                    <div class="block-content block-content-full text-end bg-body">
                        <button class="btn btn-sm btn-success" type="submit" name="AddTick">Thêm Ngay</button>
