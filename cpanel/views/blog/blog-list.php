<?php
// statically decompiled from blog-list.php  [structured; all 1 record(s) structured]
...
echo '<main id="main-container">
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h4 class="page-title fw-semibold fs-18 mb-0"><i class="fa-solid fa-users"></i> Blogs</h4>
        </div>
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <div class="d-flex">
                    <a href="/cpanel/blog/add" class="btn btn-sm btn-primary btn-wave waves-light waves-effect waves-light"><i class="fa fa-plus"></i> Thêm bài viết</a>
                </div>
            </div>
...
echo '" name="title" placeholder="Title">
                        ...
                        <div class="col-md-3 col-6">
                            <select class="form-control mb-1" name="category">
                                ...
                                ';
foreach ($db->get_list(' SELECT * FROM `post_category` ') as $listcategory) {
    echo '                                    <option ';
...
echo '                            </select>
                        ...
                        <div class="col-lg col-md-4 col-6">
                            <input type="text" name="create_gettime" class="form-control" id="daterange" value="';
echo $create_gettime;
...
foreach ($listDatatable as $row) {
    ...
    echo $row['id'];
    echo '\')">
                                    <td class="text-center"><input id="stt';
    echo $row['id'];
    ...
    echo $row['image'];
    echo '" width="100px"> </td>
                                    <td><a class="text-primary" href="/cpanel/blog/category/update/';
    echo $row['category_id'];
    echo '" target="_blank"><i class="fa fa-pencil-alt"></i>
                                            ';
