...
<div id="traffic-history" class="traffic-history"><h2>Lịch sử nhận nhiệm vụ</h2><table><tr><th>Nhiệm vụ</th><th>Trạng thái</th><th>Thưởng</th></tr><?php foreach($history as $h):?><tr><td><?=htmlspecialchars($h['title'],ENT_QUOTES)?></td><td><?=htmlspecialchars($h['status'],ENT_QUOTES)?></td><td><?=format_cash($h['reward'])?>đ</td></tr><?php endforeach;?></table></div>
