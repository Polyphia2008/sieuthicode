<?php
// statically decompiled from coupons.php  [structured; all 1 record(s) structured]
...
if (isset($_POST['AddCoupon']) && $data_user['level'] == 'admin') {
    ...
    echo $code;
    echo '" name="code" placeholder="Mã giảm giá">
                                </div>
                                <div class="col-lg col-md-4 col-6">
                                    <input type="text" name="createdate" class="form-control form-control-sm" id="daterange" value="';
    echo $createdate;
    ...
    foreach ($coupons as $row) {
        ...
        echo '</b><br>
                                            (';
        echo $row['amount'] <= $row['used'] ? '<span style="color:red">Đã sử dụng hết</span>' : '<span style="color:green">Còn ' . $row['amount'] - $row['used'] . ' lượt sử dụng</span>';
        echo ')
                                            </td>
                                            <td>
                                                <span class="badge bg-info-transparent">Áp dụng cho toàn bộ</span>
                                            </td>
                                            <td class="text-center"><span style="font-size: 15px;" class="badge bg-info">';
        echo format_cash($row['amount']);
        echo '</span>
                                            </td>
                                            <td class="text-center"><span style="font-size: 15px;" class="badge bg-danger">';
        echo format_cash($row['used']);
        echo '</span>
                                            </td>
                                            <td><span style="font-size: 15px;" class="badge bg-primary">';
        echo $row['discount'];
        echo '%</span></td>
                                            <td>';
        echo $row['createdate'];
        echo '</td>
                                            <td class="text-center">
                                                <a type="button" href="/cpanel/coupon/edit/';
        echo $row['id'];
        echo '" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="Edit">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                                <a type="button" onclick="confirmAction(';
        echo $row['id'];
        echo ')" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="Delete">
