...
if ($data_user['ctv'] != 1 && $data_user['ctv_account'] != 1) {
    new Redirect('/ctv/subcategory/view');
}
$sotin1trang = 12;
if (isset($_GET['page'])) {
...
$where = ' `id` > 0 AND `username_post` = \'' . $data_user['username'] . '\'';
$idacc = '';
$create_date = '';
$username = '';
$username_post = '';
...
echo '                                    </select>
                                ...
                                <div class="col-sm-4 mb-2">
                                    ...
                                    <a class="btn btn-danger" href="/ctv/account/sold"><i class="fa fa-trash"></i>
                                        Reset
                                    </a>
                                </div>
...
if ($sotin1trang < $total) {
    echo '<center>' . pagination('/ctv/account/sold?idacc=' . $idacc . '&username=' . $username . '&username_post=' . $username_post . '&type_category=' . $type_category . '&create_date=' . $create_date . '&', $from, $total, $sotin1trang) . '</center>';
}
echo '                    </div>
                </div>
            </div>
