<?php
// statically decompiled from edit-coupon.php  [structured; all 1 record(s) structured]
...
if (isset($_POST['SaveCoupon']) && is_admin_account($data_user)) {
    ...
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><i class="fa-solid fa-tags"></i> Chỉnh sửa mã giảm giá \'<b style="color:red;">';
    echo $row['code'];
    echo '</b>\'</h1>
