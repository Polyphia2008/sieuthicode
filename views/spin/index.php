...
echo '\');
                    var wheelPrice = ';
echo (int) ($row['price'] - $row['price'] * $row['sale'] / 100);
echo ';
                    $("#radio-payments1").attr({"data-money": ';
echo $user ? (int) $data_user['money'] : 0;
echo ', "data-giamoi": wheelPrice});
                    $("#radio-payments2").attr({"data-money": ';
echo $user ? (int) $data_user['cost'] : 0;
echo ', "data-giamoi": wheelPrice});
