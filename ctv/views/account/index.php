...
if (isset($_GET['id']) && $data_user['ctv'] == 1 && $data_user['ctv_account'] == 1) {
    $id = Anti_xss($_GET['id']);
...
<script>
    ...
    function deleteConfirm() {
        var checkbox = document.getElementsByName(\'form-check-input\');
