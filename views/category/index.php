        ...
        <div class="screen">
            <div class="center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a class="text-decoration-none" href="/nick-game"><span>Nick game</span></a></li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="screen">
    <div class="center">
        <div class="title-nickgame">
            <h3>Danh sách mục Nick game</h3>
            <hr>
            <h4>Chọn game bạn muốn mua</h4>
        </div>
        <div class="section-container-index">
            ';
foreach ($db->get_list('SELECT * FROM `subcategory` WHERE  `status` = 1 ORDER BY `stt` ASC') as $sub) {
